    ...
    { 
        ...
        protected void AddDropDownListSearchTask()
        {
            ...
            using (MySqlConnection con = new MySqlConnection(connection))
            {
                ...
                string query = "SELECT id, name FROM `tasks`";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@managerID", Convert.ToInt32(Session["id"]));

            string selectedValue = DropDownList1.SelectedValue;

            // Преобразовать значение в int

            if (Convert.ToInt32(selectedValue) != null)
                cmd.Parameters.AddWithValue("@actingID", Convert.ToInt32(selectedValue));
            else
